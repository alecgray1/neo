...
Blueprints can attach to devices in three ways:

```typescript
type AttachmentRule =
  | { type: "instance"; deviceId: string }           // Specific device
  | { type: "type"; deviceType: string }             // All devices of type
  | { type: "query"; filter: QueryFilter }           // Query-based
  ;

// Examples:
{ type: "instance", deviceId: "vav-101" }            // Just VAV-101
{ type: "type", deviceType: "VAV" }                  // All VAVs
{ type: "query", filter: { type: "VAV", tags: ["floor-3"] } }  // Floor 3 VAVs
```
