...
export interface WebviewViewProvider {
     ...
     */
    resolveWebviewView(webviewView: WebviewView, context: WebviewViewResolveContext): void | Promise<void>;
}
/**
...
export interface WindowAPI {
     ...
     * @returns A promise that resolves to the selected item or undefined
     */
    showQuickPick(items: QuickPickItem[] | string[], options?: QuickPickOptions): Promise<QuickPickItem | string | undefined>;
    /**
